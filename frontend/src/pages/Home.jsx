...
import machine3 from "../assets/Rectangle 6.png";
import machine4 from "../assets/Rectangle 8.png";
import productsBg from "../assets/backgrnd3.png";
    ...
    <div className="bg-black">
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            <div className="max-w-xl">
              ...
              <p className="text-black text-sm md:text-lg leading-relaxed font-light">
                Hands-on cosmetology training, internationally recognised
            ...
            <div className="w-full lg:w-1/2 relative min-h-[420px]">
              <div className="relative rounded-2xl overflow-hidden h-full min-h-[420px]">
                <img
                  ...
                  className="w-full h-full min-h-[420px] object-cover block rounded-2xl"
                />
              </div>
            </div>
      ...
      >
        ...
        <div className="w-full overflow-hidden py-6">
          ...
          {/* className={`home-carousel-track flex items-start gap-6 ${
  isResetting ? "" : "transition-transform duration-700 ease-in-out"
