...
import detailBg from "../assets/Frame 455.webp";
    ...
    <div className="bg-[#f7f7f7] min-h-screen font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <div className="relative w-full">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-16 -mt-36 md:-mt-40 relative z-10">
          ...
          >
            <h1 className="text-3xl md:text-3xl font-semibold text-black mb-5 tracking-tight">
              {product.title}
            </h1>
      ...
      <section className="pt-28 md:pt-32 pb-8 px-6 md:px-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-stretch">
          ...
          <div className="lg:col-span-7 pb-4 min-w-0">
            ...
            {/* BIG IMAGE OF THE SELECTED PRODUCT */}
            {/* <div className="rounded-2xl overflow-hidden w-full h-[260px] md:h-[320px] lg:h-[360px] mb-12 bg-white border border-gray-100 shadow-sm flex items-center justify-center p-4">
              <img
            ...
            {/* BIG IMAGE OF THE SELECTED PRODUCT */}
            <div className="rounded-2xl overflow-hidden w-full h-[260px] md:h-[320px] lg:h-[360px] mb-12 bg-[#f0f0f0]">
              <img
                src={product.mainImage}
                alt={product.title}
          ...
          {/* -------- RIGHT COLUMN (locked while left scrolls) -------- */}
          <div className="lg:col-span-5">
            <div className="lg:sticky lg:top-24 max-w-[420px] lg:ml-auto space-y-5 self-start">
              {/* Product Card */}
              <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 flex flex-col">
                <div className="bg-[#f0f0f0] h-[210px] md:h-[230px] w-full overflow-hidden">
                  <img
                    src={product.mainImage}
                    alt={product.title}
                    className="w-full h-full object-cover object-center"
      ...
      {/* ================= RELATED PRODUCTS (3 CARDS FROM DB) ================= */}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-12">
              {product.relatedProducts.map((rp) => (
                ...
                >
                  <div className="bg-[#f0f0f0] h-[230px] md:h-[250px] w-full overflow-hidden shrink-0">
                    <img
                      src={rp.mainImage}
                      alt={rp.title}
                      className="w-full h-full object-cover object-center"
