...
import aboutBg from "../assets/aboutBGimg.webp"; // Updated to use the .webp version of the image
  ...
  useEffect(() => {
    ...
    const loadFounders = async () => {
      try {
        ...
        const data = res.data?.data || [];
        setFounders(data.length ? data : foundersFallback);
      } catch (err) {
        console.error("Error loading Founders:", err);
        setFounders(foundersFallback);
      }
    };
    ...
    <div className="bg-[#f7f7f7] min-h-screen font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <section className="bg-[#f7f7f7] pt-20 pb-16 px-6 md:px-16">
        <div className="max-w-4xl mx-auto">
          <p className="text-black text-base md:text-xl leading-relaxed mb-8">
            Lorem Ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industLorem Ipsum is simply dummy
          ...
          <p className="text-black text-base md:text-xl leading-relaxed">
            ...
            typesetting industry. Lorem Ipsum has been the industLorem Ipsum is
            simply dummy text of the printing and is simply dummy text of the
      ...
      <section className="w-full bg-[#e8d5b7] py-24 md:py-32">
        <div className="max-w-4xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-10 sm:gap-6">
          ...
          {/* Stat 2 */}
          <div className="text-center flex-1">
            <p className="text-5xl md:text-6xl font-bold text-white mb-2">#1</p>
      ...
      ========================================================= */}
       <section className="bg-[#f7f7f7] py-20 md:py-28 px-6 md:px-16">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-[40%] flex flex-col justify-center lg:pl-10 xl:pl-16">
            ...
            <p className="text-black text-base md:text-xl leading-[1.75]">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry. Lorem Ipsum has been the industLorem Ipsum iLorem Ipsum
              is simply dummy text of the printing and typesetting industry.
              Lorem Ipsum has been the industLorem Ipsum iLorem Ipsum is simply
      ...
      {/* =========================================================
          MISSION & VALUES
      ========================================================= */}
      <section className="bg-[#f7f7f7] py-20 md:py-28 px-6 md:px-16 overflow-hidden">
        <div className="max-w-7xl mx-auto relative min-h-[820px] md:min-h-[900px]">
          ...
          <div className="relative md:absolute md:left-0 md:top-24 w-full md:w-[65%] min-h-[580px] md:min-h-[740px] bg-[#e8d5b7] p-8 md:p-14 lg:p-16 z-10 mt-6 md:mt-0 flex items-center">
            <div className="max-w-md space-y-3">
              ...
              <h2 className="text-3xl md:text-4xl font-semibold text-black mb-6 leading-[1.15] tracking-tight">
                <span className="block">Mission &amp;</span>
                <span className="block mt-2">Values</span>
              </h2>

              <p className="text-black  text-xl md:text-xl leading-[2]">
                Lorem Ipsum is simply dummy text of the printing and typesetting
      ...
      <section className="bg-[#f7f7f7] py-20 md:py-28 px-6 md:px-16">
        <div className="max-w-7xl mx-auto">
          <p className="text-xl text-black/70 mb-6 md:mb-8">Our Founders</p>
